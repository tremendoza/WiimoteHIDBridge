/*
Filename: hidminiport.h
Abstract: Header for the pass-through HID Class minidriver bridge.
*/
...
_Dispatch_type_(IRP_MJ_OTHER) DRIVER_DISPATCH PassThrough;
_Dispatch_type_(IRP_MJ_POWER) DRIVER_DISPATCH PowerPassThrough;
_Dispatch_type_(IRP_MJ_PNP) DRIVER_DISPATCH PnPPassThrough;
